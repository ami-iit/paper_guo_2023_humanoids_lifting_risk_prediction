...
class PlotInferenceResults:
    def __init__(self):
        ...
        #self.ax01.legend(["jLeftKnee_roty", "jLeftKnee_roty predictions"])
        self.ax01.grid(True)
        ...
        self.p2, = self.ax01.plot(self.t_prediction, self.joint_predictions, 'o', color='k', markersize=4, alpha=0.02)
